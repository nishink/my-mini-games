    ...
    init(parentContainer) {
        ...
        this.container.innerHTML = `
            <div class="dialogue-box ui-panel">
                ...
                <div class="next-indicator">▼ <span style="font-size: 0.7rem; vertical-align: middle;">クリックで進む</span></div>
            </div>
        `;
        ...
        this.indicatorEl = this.container.querySelector('.next-indicator');
